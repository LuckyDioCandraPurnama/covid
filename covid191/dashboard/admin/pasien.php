                    ...
                    <div class="rect-welcome">
                        <div class="col-sm">
                            <div class="row">
                                <div class="col-md-5">
                                    <h2>Daftar Pasien</h2>
                                    <p>Website ini adalah alat sederhana yang bisa membantu menentukan apakah
                                      Anda sehat-sehat saja atau ada gejala yang memerlukan penilaian,
                                       pemeriksaan dan pengujian lebih lanjut untuk COVID-19.</p>
                                </div>
                                <div class="col-md-7 text-center ">
                                    <img src="../../images/cat.svg" class="w-50" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
