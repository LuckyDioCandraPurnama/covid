            ...
            <div class="container-fluid p-3">
                <nav class="navbar navbar-expand-lg ">
                    <a class="navbar-brand" href="#">
                        <span><i class="fab fa-medrt"></i> Self-CheckUp</span></a>
        ...
        <main>
            ...
            <section class="tentang" id="about">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7 col-sm-12">
                            <img src="images/medic.svg" alt="Lets Check">
                        </div>
            ...
            <section class="tips" id="tips">
                ...
                <div class="container-fluid text-center">
                    <div class="numbers d-flex flex-md-row flex-wrap justify-content-center">
                        <div class="rect">
                            <div class="col-sm-12">
                              <img src="images/wash.svg" alt="cuci" class="tipss">
                              <h5>Cuci Tangan</h5>
                              <p>Menggunakan sabun dan bilas dengan air</p>
                            </div>
                        </div>
                        <div class="rect">
                            <div class="col-sm-12">
                              <img src="images/masker.svg" alt="masker" class="tipss">
                              <h5>Gunakan Masker</h5>
                              <p>Keluar rumah selalu gunakan masker</p>
                            </div>
                        </div>
                        <div class="rect">
                            <div class="col-sm-12">
                              <img src="images/sosting.svg" alt="Sosting" class="tipss">
                              <h5>Physical Distancing</h5>
                              <p>Menjaga jarak dari orang lain minimal 1 meter</p>
                            </div>
                        </div>
                        <div class="rect">
                            <div class="col-sm-12">
                              <img src="images/stay.svg" alt="home" class="tipss">
                              <h5>Berdiam Di Rumah</h5>
                              <p>Berdiam diri di rumah selama 14 hari untuk meningkatkan sistem imun tubuh</p>
                            </div>
                        </div>
                        <div class="rect">
                            <div class="col-sm-12">
                              <img src="images/doctor.svg" alt="dokter" class="tipss">
                              <h5>Pergi Ke Dokter</h5>
                              <p>Jika mengalami gejala segera pergi ke rumah sakit</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-5 col-sm-12 text-left">
                            ...
                            <p>
                                Nama Lengkap : Lucky Dio Candra Purnama
                                <br>
                                Jenis Kelamin : Laki-Laki
                                <br>
                                Tempat, Tanggal Lahir : Jember, 27 Maret 2004
                                <br>
                                Alamat : Jl. Ahmad Yani,Balung, Jember
                                <br>
                                Agama : Islam
                            </p>
                        </div>
                        <div class="col-md-7 col-sm-12">
                            <img src="images/develop.jpg" alt="Developed" style="width: 220px; margin-left: 300px; border-radius: 10px;">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="container-fluid">
                <div class="row text-left">
                    <div class="col-md-5 col-sm-5">
                        <h4 class="text-light"><span><i class="fab fa-medrt"></i>Self-Checkup</h4>
                          <p class="text-light">
                              Website ini adalah alat sederhana yang bisa
                              membantu menentukan apakah Anda sehat-sehat saja atau ada gejala yang memerlukan penilaian,
                              pemeriksaan dan pengujian lebih lanjut untuk COVID-19.
                          </p>
                          <p class="text-light"><span><i class="fab fa-facebook-f"></i> SelfCheckup</p>
                          <p class="text-light"><span><i class="fab fa-instagram"></i> Self_Checkup</p>
                          <p class="text-light"><span><i class="fab fa-twitter"></i> Self_Checkup</p>

                          <p class="pt-4 text-light">Thank you
